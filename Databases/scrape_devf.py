...
# print(tags_name)
  ...
  event_months=[ob.split(" ")[0] for ob in event_dates]
# print(event_dates)
################################################
dataframe_set = pd.DataFrame(list(zip(event_names,event_dates,event_months)),columns=["Names","Date and Time","Month"])
dataframe_set.to_csv("Hac2.csv")
